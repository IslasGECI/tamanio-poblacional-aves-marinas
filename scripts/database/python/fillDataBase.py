...
def create_registry(conexion, renglon):
    ...
    maximo_numero_individuos = renglon['Máxima cantidad o cantidad total de nidos (parejas)']
...
if __name__ == '__main__':
    ...
    tabla_datos = pd.read_excel('./base_datos_parejas_aves_marinas_islas.xlsx').dropna(subset=['Isla/Grupo islas'])
    with conexion:
